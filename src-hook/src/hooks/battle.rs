...
//!   i.e. a singleton pointer at `LINK_TIME_SINGLETON_RVA` whose byte `+0x10` carries
...
const LINK_TIME_SINGLETON_RVA: usize = 0x7032240; // 2.0.5: 0x7031200
...
const EM_MODE_COMPONENT_TYPE_RVA: usize = 0x7bb908c; // 2.0.5: 0x7bb804c
