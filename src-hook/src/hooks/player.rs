...
const SAVE_ROOT_RVA: usize = 0x7c23e80; // 2.0.5: 0x7c22e40
...
const WEAPON_TABLE_RVA: usize = 0x7c23ff8; // 2.0.5: 0x7c22fb8
...
/// v2.0.3: re-derived 2026-07-31 from two independent sites that agree — the
...
const CHARA_POWER_RVA: usize = 0x7c23f78; // 2.0.5: 0x7c22f38
